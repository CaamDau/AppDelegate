...
Pod::Spec.new do |s|
  s.name             = 'CaamDauAppDelegate'
  s.version          = '2.0.0'
  s.summary          = 'CaamDau 系列产品：iOS AppDelegate 解耦方案'
  s.description      = <<-DESC
  ...
  s.source           = { :git => 'https://github.com/CaamDau/AppDelegate.git', :tag => s.version }

  s.ios.deployment_target = '9.0'
  s.swift_version = ['4.0', '4.2', '5.0', '5.1']
  s.source_files = 'AppDelegate/**/*'
